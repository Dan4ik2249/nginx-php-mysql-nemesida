        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="alert alert-success alert-dismissable">
                    ...
                    Запись <?php echo $_POST['registo']; ?> была успешно добавлена.
                </div>
                <?php 
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="myModalLabel2">Изменить страницу</h4>
                                    </div>
...
ORDER BY regcounter, campocnt
                                    ...
                                    <?php }else{ ?>
                                        <tr><td><?php echo $registo['cnome']; ?></td><td>=</td><td><?php echo $registo['valor']; ?></td></tr>
                                    <?php }}} else{ echo "<tr><td></td><td>(нет связанных записей)</td><td></td><td></td></tr>"; } ?>
                        ...
                        <a data-toggle="modal" data-target="#modalr-add" href="#">
                            <div class="panel-footer">
                                <span class="pull-left">Регистрация</span>
                ...
                <?php }else{ echo "Страница не существует!"; } ?>
